...
public class Main extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (grafo == null) {
            ...
            JOptionPane.showMessageDialog(null,"El archivo se actualizo en: "+path );
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (grafo == null) {
            ...
            recorrido.setText("Profundidad " + "Islas: "+Integer.toString(contIslas));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null,"Para que el boton mostrar grafo funcione es necesario añadir los archivos .jar "
                + "\n"+"en el folder Libraries dentro de netbeans, los archivos .jar se encuentran en la carpeta Librerias ");
